...
enum HalBoardLedPins {
  ...
  BOARDLED1 = PORTA_PIN(7), // PA7 - -//-
  BOARDLED2 = PORTB_PIN(6), // PB6 - on the development board
  BOARDLED3 = PORTC_PIN(0), // PC0 - -//-
